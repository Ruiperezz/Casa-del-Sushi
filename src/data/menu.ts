...
export const REVIEWS: Review[] = [
  {
    id: "rev-1",
    author: "Alejandro Lorenzo Martínez",
    rating: 5,
    text: "El mejor de cartagena, buenísima ubicación.",
    date: "Hace 1 día",
    avatarSeed: "alejandro",
    reviewCount: "3 reseñas · 3 fotos",
  },
  {
    id: "rev-2",
    author: "encarni martinez",
    rating: 5,
    text: "Ayer fuimos a cenar 3 personas y todas coincidimos en lo bueno que esta todo y la calidad que tiene. Súper atentos y servicio rápido. Volveremos!",
    date: "Hace 4 días",
    avatarSeed: "encarni",
    badge: "Local Guide",
    reviewCount: "17 reseñas · 24 fotos",
  },
  {
    id: "rev-3",
    author: "Taha Bechchari",
    rating: 5,
    text: "Perfecto",
    date: "Hace 5 días",
    avatarSeed: "taha",
  ...
  },
  {
    ...
    author: "Yixuan Jia",
    rating: 5,
    text: "¡Menudo descubrimiento! Muy bien ubicado y comodísimo para aparcar con el parking público al lado. El sitio es precioso y elegante, y la relación calidad-precio es genial. Es un buffet con un montón de variedad, raciones muy generosas y un sabor espectacular. Si quieres auténtico sabor asiático, no busques más. ¡Superrecomendado!",
    date: "Hace una semana",
    avatarSeed: "yixuan",
    reviewCount: "4 reseñas · 7 fotos",
  },
  {
    id: "rev-5",
    author: "郑金峰",
    rating: 5,
    text: "La comida estaba buenísima y el ambiente muy agradable y bonito. Todo muy limpio, el servicio excelente y la experiencia en general fue perfecta. Sin duda volveremos.",
    date: "Hace una semana",
    avatarSeed: "zheng",
    badge: "Local Guide",
    reviewCount: "12 reseñas · 39 fotos",
  },
];
